# USO: python setup_v11.py py2exe

#!/usr/bin/python3
# -*- coding: utf-8 -*-
# Created by: python.exe -m py2exe revision_v1_1.py -W setup_v11.py
...
revision_v1_1 = Target(
    ...
    script="revision_v1_1.py", # path of the main script

    # Allows to specify the basename of the executable, if different from 'revision_v1_1'
    # dest_base = "revision_v1_1",

    # Icon resources:[(resource_id, path to .ico file), ...]
    # icon_resources=[(1, r"revision_v1_1.ico")]

    other_resources = [(RT_MANIFEST, 1, (manifest_template % dict(prog="revision_v1_1", level="asInvoker")).encode("utf-8")),
