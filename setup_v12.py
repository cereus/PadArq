# USO: python setup_v12.py py2exe

#!/usr/bin/python3
# -*- coding: utf-8 -*-
# Created by: python.exe -m py2exe revision_v1_2.py -W setup_v12.py
...
revision_v1_2 = Target(
    ...
    script="revision_v1_2.py", # path of the main script

    # Allows to specify the basename of the executable, if different from 'revision_v1_2'
    # dest_base = "revision_v1_2",

    # Icon resources:[(resource_id, path to .ico file), ...]
    # icon_resources=[(1, r"revision_v1_2.ico")]

    other_resources = [(RT_MANIFEST, 1, (manifest_template % dict(prog="revision_v1_2", level="asInvoker")).encode("utf-8")),
